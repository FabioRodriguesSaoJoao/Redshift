...
def listar_produtos(connection):
    try:
        cursor = connection.cursor()
        # Execute uma consulta SQL para selecionar todos os dados da tabela
        query = "SELECT id_good_item as codigo_produto, des_item_good_name as nome, vlr_item_desired_price as valor FROM trusted_vmpay.tb_planograms where id_planogram = 525437"
